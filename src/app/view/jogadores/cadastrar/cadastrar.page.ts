...
export class CadastrarPage  implements OnInit {
  ...
  ngOnInit() {
    this.formCadastrarJ = this.formBuilder.group({
      nome: ['', [Validators.required, Validators.minLength(2), Validators.pattern(/^[a-zA-Z\s-]+$/)]],
      ...
      universidade: ['', [Validators.required, Validators.minLength(3), Validators.pattern(/^[a-zA-Z\s-]+$/)]],
