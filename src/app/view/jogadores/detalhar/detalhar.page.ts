...
export class DetalharPage implements OnInit {
  ...
  ngOnInit() {
    ...
    this.formEditar = this.formBuilder.group({
      nome: [this.jogador.nome, [Validators.required, Validators.minLength(2), Validators.pattern(/^[a-zA-Z\s-]+$/)]],
      ...
      universidade: [this.jogador.universidade, [Validators.required, Validators.minLength(3), Validators.pattern(/^[a-zA-Z\s-]+$/)]],
